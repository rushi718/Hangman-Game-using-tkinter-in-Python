...
class Hangman:
    ...
    def structure(self,master):
        ...
        self.reset_bttn.grid(row = 3, column = 1, sticky = W)
        ...
        self.c=Canvas(master,height=300,width=200,bg="blue")
        self.c.grid(row=9,column=0,sticky =W)
        self.l=self.c.create_line(20,20,20,250,width=2)
        self.l1=self.c.create_line(20,20,100,20,width=2)
        self.l2=self.c.create_line(100,20,100,50,width=2)
    ...
    def submit(self):
        ...
        if char in actual and len(char)!=0:
            i=actual.index(char)
        ...
        if(self.count==1):
            self.cir=self.c.create_oval(75,100,125,50,width=2)
        elif(self.count==2):
            self.el=self.c.create_line(85,65,95,65,width=2)
        elif(self.count==3):
            self.er=self.c.create_line(105,65,115,65,width=2)
        elif(self.count==4):
            self.no=self.c.create_line(100,70,100,85,width=2)
        elif(self.count==5):
            self.mo=self.c.create_line(90,90,110,90,width=2)
        elif(self.count==6):
            self.l3=self.c.create_line(100,100,100,200,width=2)
        elif(self.count==7):
            self.hl=self.c.create_line(100,125,50,150,width=2)
        elif(self.count==8):
            self.hr=self.c.create_line(100,125,150,150,width=2)
        elif(self.count==9):
            self.fl=self.c.create_line(100,200,50,225,width=2)
        elif(self.count==10):
            self.fr=self.c.create_line(100,200,150,225,width=2)
